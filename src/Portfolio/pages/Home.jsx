        ...
        <div className="introduccion container justify-content-center">
            ...
            <div className="d-flex mt-5 introduccion_redes">
              ...
              <a href="https://www.behance.net/AlanFranquez" target='_blank'>
                <div className="mx-2 introduccion__redes_logos">
                  <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-behance" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#7C73E6" fill="none" stroke-linecap="round" stroke-linejoin="round">
                  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
